"""skuska_24123 URL Configuration
...
admin.site.site_header = "skuska"
admin.site.site_title = "skuska Admin Portal"
admin.site.index_title = "skuska Admin"

# swagger
api_info = openapi.Info(
    title="skuska API",
    default_version="v1",
    description="API documentation for skuska App",
)
